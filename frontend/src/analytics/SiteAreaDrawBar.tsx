...
export function SiteAreaDrawBar({
  ...
  return (
    <div
      ...
      className="absolute left-1/2 top-3 z-10 flex w-[min(36rem,calc(100%-1.5rem))] -translate-x-1/2 flex-col gap-2 rounded-[10px] border border-line bg-panel p-3 shadow-float"
    >
      {polygon ? (
        <form
