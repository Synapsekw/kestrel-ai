...
export function ConfidenceFloor({ value, hidden, onChange }: Props) {
  ...
  return (
    <label data-testid="confidence-floor" className="flex items-center gap-2 px-1 text-[13px] text-muted">
      Hide suggestions
      ...
      <input
        ...
        className={cx("h-4 w-24 cursor-pointer rounded-full accent-[rgb(var(--accent))]", focusRing)}
      />
