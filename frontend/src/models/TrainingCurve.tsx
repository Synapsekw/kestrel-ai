  ...
  return (
    <figure className="flex flex-col gap-1">
      ...
      >
        ...
        {map5095 && (
          <polyline points={map5095} fill="none" stroke="#38bdf8" strokeWidth={1.5} strokeDasharray="4 3" />
        )}
      ...
      <figcaption className="text-xs text-slate-400">
        <span className="text-orange-400">mAP50</span> and <span className="text-sky-400">mAP50-95</span> per
        epoch from results.csv (last: {formatMetric(last.map50)} / {formatMetric(last.map50_95)})
      </figcaption>
    </figure>
  );
}
