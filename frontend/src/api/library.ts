...
/**
 * The scale the model was trained at, derived from the dataset it was trained on, with the evidence
 * for it. 404 when nothing can be measured: no dataset in its provenance, a project folder that no
