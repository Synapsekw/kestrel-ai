...
| U1 | S2 Datasets screen (plan `2026-09-19-s2-datasets-screen.md`; worktree `.worktrees/s2-datasets-screen`, contract 6cb373a), then G2 results export (plan `2026-09-19-g2-results-export.md`; owner wants CSV, YOLO/COCO, HTML report, unreviewed option, ONNX for other applications; worktree `.worktrees/g2-results-export`, contract 52e6ce9 + 920e32e) | s2-datasets-screen, g2-results-export | S2 implementer dispatched (sonnet) at 0d8bef2; G2 starts when S2 is merged and verified | none |
...
| U2 | Site office UI redesign (spec `2026-09-19-site-office-ui-design.md`, plan `2026-09-19-u2-site-office-ui.md`, `PRODUCT.md`, `DESIGN.md`) | ui-site-office | every screen restyled on `frontend/src/ui/`; pipeline sidebar, project Home, Label step, toasts; unit, e2e and the walk-through driver updated; screenshots `docs/evidence/ui/2026-09-19-site-office/` | branched from wave1-s2-trial at 8299964 (rejected dataset-delete code): rebase onto main after the usability wave merges, per the owner's ordering |
