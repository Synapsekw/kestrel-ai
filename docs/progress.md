...
| U1 | G2 results export (plan `2026-09-19-g2-results-export.md`; contract 52e6ce9 + 920e32e): CSV tables, YOLO/COCO labels, HTML report, unreviewed option, ONNX for other applications, Show in folder (M3) | g2-results-export (worktree `.worktrees/g2-results-export`, brought up to usability-wave1 7e2b668) | implementer dispatched (sonnet) after S2 was merged and verified | none |
