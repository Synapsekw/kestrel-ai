...
Separately, `rasterio._shim` (also listed) does not exist in rasterio 1.4.4 — PyInstaller logs
`ERROR: Hidden import 'rasterio._shim' not found` at build time, but this is harmless noise, not
a functional gap: the module was removed/renamed upstream and nothing in this rasterio version
imports it.
